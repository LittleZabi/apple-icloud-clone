export default () => {
  return (
    <header className="toolbar-banner" role="banner">
      <div className="application-toolbar login-theme">
        <div className="toolbar-container">
          <div className="application-toolbar-start-view">
            <div className="cloudos-application-toolbar-start-view">
              <a
                href=""
                aria-label="Navigate to icloud.com home page"
                className="ICloudLogo unstyled-link nav-link"
              >
                <svg
                  width="90"
                  height="31"
          ...
          <div className="application-toolbar-end-view">
            <div className="cloudos-application-toolbar-end-view">
              <div className="toolbar-buttons-container">
                <ui-button
                  className="push primary toolbar-icon-button help-icon"
                  tabIndex="0"
                  ontouchstart="void(0)"
                  role="button"
